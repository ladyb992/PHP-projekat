        ...
        function iscrtaj() {
            var jsonData = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json",
                dataType:"json",
                async: false
            }).responseText;

            var a = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=1",
                dataType:"json",
                async: false
            }).responseText;

            var b = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=2",
                dataType:"json",
                async: false
            }).responseText;

            var c = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=3",
                dataType:"json",
                async: false
            }).responseText;

            var d = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=4",
                dataType:"json",
                async: false
            }).responseText;

            var e = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=5",
                dataType:"json",
                async: false
            }).responseText;
            var f = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=6",
                dataType:"json",
                async: false
            }).responseText;

            var g = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=7",
                dataType:"json",
                async: false
            }).responseText;

            var h = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=8",
                dataType:"json",
                async: false
            }).responseText;

            var i = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=9",
                dataType:"json",
                async: false
            }).responseText;

            var j = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=10",
                dataType:"json",
                async: false
            }).responseText;

            var k = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=11",
                dataType:"json",
                async: false
            }).responseText;

            var l = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=12",
                dataType:"json",
                async: false
            }).responseText;

            var m = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=13",
                dataType:"json",
                async: false
            }).responseText;

            var n = $.ajax({
                url: "http://localhost/domaci3JS/vizuelizacija.json?pisac=14",
                dataType:"json",
                async: false
            }).responseText;
